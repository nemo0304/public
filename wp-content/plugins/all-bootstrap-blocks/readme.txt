...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/all-bootstrap-blocks)
...
* FIX: Layout set to null instead of string in list group block.json
...
* FEATURE: https://wordpress.org/support/topic/feature-request-show-div-ids-in-the-editor/
* FIX: https://wordpress.org/support/topic/accordion-icon-active-color-not-working/

= 1.3.24 =
* FEATURE: https://wordpress.org/support/topic/feature-request-set-title-for-areoi-full-link/

= 1.3.23 =
* FIX: https://wordpress.org/support/topic/hide-buttons-and-columns-block-does-not-work/

= 1.3.22 =
* FIX: https://wordpress.org/support/topic/typeerror-cannot-read-properties-of-undefined-reading-getblocks/

= 1.3.21 =
* FIX: https://wordpress.org/support/topic/uncaught-typeerror-in-areoi-1-3-20/
* FIX: https://wordpress.org/support/topic/duplicated-accordion-items-same-id-issue/

= 1.3.20 =
* FIX: Vulnerability fix reported by patchstack

= 1.3.19 =
* FIX: https://wordpress.org/support/topic/block-save-as-template-and-add-in-new-page-dont-change-the-class/#post-17860272
* FIX: Allowed modal to be closed using escape key
* FIX: https://wordpress.org/support/topic/div-block-not-saving-external-links/
...
= 1.3.17 =
* FIX: Vulnerability fix reported by patchstack
* FIX: https://wordpress.org/support/topic/horizontal-rules-issues/
