...
use ABB\ScssPhp\ScssPhp\Base\Range;
use ABB\ScssPhp\ScssPhp\Compiler\CachedResult;
use ABB\ScssPhp\ScssPhp\Compiler\Environment;
use ABB\ScssPhp\ScssPhp\Exception\CompilerException;
use ABB\ScssPhp\ScssPhp\Exception\ParserException;
use ABB\ScssPhp\ScssPhp\Exception\SassException;
use ABB\ScssPhp\ScssPhp\Exception\SassScriptException;
use ABB\ScssPhp\ScssPhp\Formatter\Compressed;
use ABB\ScssPhp\ScssPhp\Formatter\Expanded;
use ABB\ScssPhp\ScssPhp\Formatter\OutputBlock;
use ABB\ScssPhp\ScssPhp\Logger\LoggerInterface;
use ABB\ScssPhp\ScssPhp\Logger\StreamLogger;
use ABB\ScssPhp\ScssPhp\Node\Number;
use ABB\ScssPhp\ScssPhp\SourceMap\SourceMapGenerator;
use ABB\ScssPhp\ScssPhp\Util\Path;
...
class Compiler
{
    ...
    /**
     * @var string|\ABB\ScssPhp\ScssPhp\Formatter
     */
    ...
    /**
     * @var \ABB\ScssPhp\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \ABB\ScssPhp\ScssPhp\Parser
     */
     ...
     *
     * @return \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \ABB\ScssPhp\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \ABB\ScssPhp\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile directive
     *
     * @param \ABB\ScssPhp\ScssPhp\Block|array $directive
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \ABB\ScssPhp\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $scope
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \ABB\ScssPhp\ScssPhp\Block|\ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return boolean
     ...
     * @param array                                  $stms
     * @param \ABB\ScssPhp\ScssPhp\Formatter\OutputBlock $out
     * @param \ABB\ScssPhp\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \ABB\ScssPhp\ScssPhp\Compiler\Environment $env
     * @param \ABB\ScssPhp\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \ABB\ScssPhp\ScssPhp\Block $block
     *
     * @return \ABB\ScssPhp\ScssPhp\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\ABB\ScssPhp\ScssPhp\ValueConverter::parseValue" or "\ABB\ScssPhp\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \ABB\ScssPhp\ScssPhp\Compiler
     *
     ...
     *
     * @throws \ABB\ScssPhp\ScssPhp\Exception\CompilerException
     *
